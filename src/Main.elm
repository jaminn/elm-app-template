...
contentView model =
    div [ css [ whiteSpace preLine, overflowWrap breakWord, lineHeight (num 1.3), property "user-select" "text" ] ] [ text lawTextVal ]
...
view model =
    div [ css [ position absolute, top zero, bottom zero, right zero, left zero, displayFlex, flexDirection column ] ]
        [ div [ css [ width (pct 100), flexShrink zero, minHeight (px 60), displayFlex, justifyContent spaceBetween, alignItems stretch, boxShadow4 (px 1) (px 1) (px 10) (hex "#00000022") ] ]
            [ div [ onClick LogoClicked, css [ width (px 180), position relative, hover [ textShadow4 (px 1) (px 1) (px 10) (hex "#00000044") ], transition [ Transition.textShadow 200 ] ] ]
                [ i [ class "fas fa-gavel", css [ fontSize (px 40), color (hex "#444"), position absolute, top (px 8), left (px 18) ] ] []
